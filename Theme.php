...
namespace Shopware\Themes\Lighthouse;

use Doctrine\Common\Collections\ArrayCollection;
use Shopware\Components\Form as Form;
use Shopware\Components\Theme\ConfigSet;
use Shopware\Components\Theme as ShopwareBaseTheme;

class Theme extends ShopwareBaseTheme
{
    /**
     ...
     * @var string
     */
    protected $description = 'Optimized shopware responsive theme via google lighthouse';
     ...
     * @var string
     */
    protected $author = 'netlogix GmbH & Co. KG';
